...
pub trait WebExtensionExt: 'static {
    ...
    //fn send_message_to_context<P: FnOnce(Result</*Ignored*/UserMessage, glib::Error>) + 'static>(&self, message: /*Ignored*/&UserMessage, cancellable: /*Ignored*/Option<&gio::Cancellable>, callback: P);
