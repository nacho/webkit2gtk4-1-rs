...
mod sealed {
    pub trait Sealed {}
    impl<T: super::IsA<super::DOMHTMLElement>> Sealed for T {}
}

pub trait DOMHTMLElementExt: IsA<DOMHTMLElement> + sealed::Sealed + 'static {
    ...
    #[cfg_attr(docsrs, doc(cfg(not(feature = "v2_10"))))]
    #[allow(deprecated)]
    ...
    #[cfg_attr(docsrs, doc(cfg(not(feature = "v2_8"))))]
    #[allow(deprecated)]
    ...
    fn get_property_draggable(&self) -> bool {
        ObjectExt::property(self.as_ref(), "draggable")
    }

    fn set_property_draggable(&self, draggable: bool) {
        ObjectExt::set_property(self.as_ref(), "draggable", draggable)
    }
    ...
    fn get_property_spellcheck(&self) -> bool {
        ObjectExt::property(self.as_ref(), "spellcheck")
    }

    fn set_property_spellcheck(&self, spellcheck: bool) {
        ObjectExt::set_property(self.as_ref(), "spellcheck", spellcheck)
    }

    fn get_property_translate(&self) -> bool {
        ObjectExt::property(self.as_ref(), "translate")
    }

    fn set_property_translate(&self, translate: bool) {
        ObjectExt::set_property(self.as_ref(), "translate", translate)
    }

    fn get_property_webkitdropzone(&self) -> Option<glib::GString> {
        ObjectExt::property(self.as_ref(), "webkitdropzone")
    }

    fn set_property_webkitdropzone(&self, webkitdropzone: Option<&str>) {
        ObjectExt::set_property(self.as_ref(), "webkitdropzone", webkitdropzone)
    }

    #[doc(alias = "access-key")]
    fn connect_access_key_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_access_key_trampoline<
    ...
    fn connect_content_editable_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_content_editable_trampoline<
            P: IsA<DOMHTMLElement>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::WebKitDOMHTMLElement,
    ...
    fn connect_dir_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_dir_trampoline<P: IsA<DOMHTMLElement>, F: Fn(&P) + 'static>(
            this: *mut ffi::WebKitDOMHTMLElement,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    fn connect_draggable_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_draggable_trampoline<
            P: IsA<DOMHTMLElement>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::WebKitDOMHTMLElement,
    ...
    fn connect_hidden_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_hidden_trampoline<
            P: IsA<DOMHTMLElement>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::WebKitDOMHTMLElement,
    ...
    fn connect_inner_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_inner_text_trampoline<
            P: IsA<DOMHTMLElement>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::WebKitDOMHTMLElement,
    ...
    fn connect_is_content_editable_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_is_content_editable_trampoline<
            P: IsA<DOMHTMLElement>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::WebKitDOMHTMLElement,
    ...
    fn connect_lang_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_lang_trampoline<P: IsA<DOMHTMLElement>, F: Fn(&P) + 'static>(
            this: *mut ffi::WebKitDOMHTMLElement,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    fn connect_outer_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_outer_text_trampoline<
            P: IsA<DOMHTMLElement>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::WebKitDOMHTMLElement,
    ...
    fn connect_spellcheck_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_spellcheck_trampoline<
            P: IsA<DOMHTMLElement>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::WebKitDOMHTMLElement,
    ...
    fn connect_tab_index_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_tab_index_trampoline<
            P: IsA<DOMHTMLElement>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::WebKitDOMHTMLElement,
    ...
    fn connect_translate_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_translate_trampoline<
            P: IsA<DOMHTMLElement>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::WebKitDOMHTMLElement,
    ...
    fn connect_webkitdropzone_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_webkitdropzone_trampoline<
            P: IsA<DOMHTMLElement>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::WebKitDOMHTMLElement,
