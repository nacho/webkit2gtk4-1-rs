...
mod sealed {
    pub trait Sealed {}
    impl<T: super::IsA<super::DOMHTMLTableElement>> Sealed for T {}
}

pub trait DOMHTMLTableElementExt: IsA<DOMHTMLTableElement> + sealed::Sealed + 'static {
    ...
    fn connect_caption_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_caption_trampoline<
            P: IsA<DOMHTMLTableElement>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::WebKitDOMHTMLTableElement,
    ...
    fn connect_cell_padding_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_cell_padding_trampoline<
            P: IsA<DOMHTMLTableElement>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::WebKitDOMHTMLTableElement,
    ...
    fn connect_cell_spacing_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_cell_spacing_trampoline<
            P: IsA<DOMHTMLTableElement>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::WebKitDOMHTMLTableElement,
    ...
    fn connect_summary_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_summary_trampoline<
            P: IsA<DOMHTMLTableElement>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::WebKitDOMHTMLTableElement,
    ...
    fn connect_t_bodies_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_t_bodies_trampoline<
            P: IsA<DOMHTMLTableElement>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::WebKitDOMHTMLTableElement,
    ...
    fn connect_t_foot_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_t_foot_trampoline<
            P: IsA<DOMHTMLTableElement>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::WebKitDOMHTMLTableElement,
    ...
    fn connect_t_head_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_t_head_trampoline<
            P: IsA<DOMHTMLTableElement>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::WebKitDOMHTMLTableElement,
