...
impl Class {
    ...
    //pub fn add_constructor_variadic(&self, name: Option<&str>, callback: /*Unimplemented*/Fn(/*Ignored*/glib::PtrArray) -> /*Unimplemented*/Basic: Pointer, user_data: /*Unimplemented*/Option<Basic: Pointer>, return_type: glib::types::Type) -> Option<Value> {
    ...
    //pub fn add_method_variadic(&self, name: &str, callback: /*Unimplemented*/Fn(/*Unimplemented*/Basic: Pointer, /*Ignored*/glib::PtrArray) -> Value, user_data: /*Unimplemented*/Option<Basic: Pointer>, return_type: glib::types::Type) {
    ...
    //pub fn add_property(&self, name: &str, property_type: glib::types::Type, getter: /*Unimplemented*/Fn(/*Unimplemented*/Basic: Pointer) -> Value, setter: /*Unimplemented*/Fn(/*Unimplemented*/Basic: Pointer, &Value), user_data: /*Unimplemented*/Option<Basic: Pointer>) {
